  ...
  return (
    <form action={action} className='flex flex-col md:flex-row gap-10 my-3'>
      ...
      <div className='flex-1'>
        ...
        <AddExtras extras={extras} setExtras={setExtras} translations={translations} />
...
const UploadImage = ({
  ...
  return (
    <div className='group mx-auto md:mx-0 relative w-[200px] h-[200px] overflow-hidden rounded-full'>
      ...
      <div
        className={`${
          selectedImage ? 'group-hover:opacity-[1] opacity-0  transition-opacity duration-200' : ''
...
const AddSize = ({
  ...
  sizes: Partial<Sizes>[]
  setSizes: React.Dispatch<React.SetStateAction<Partial<Sizes>[]>>
  translations: Translations
}) => {
  return (
    <Accordion type='single' collapsible className='bg-gray-100 rounded-md px-4 w-full mb-4 '>
...
const AddExtras = ({
  ...
  setExtras: React.Dispatch<React.SetStateAction<Partial<Extras>[]>>
  translations: Translations
}) => {
  return (
    <Accordion type='single' collapsible className='bg-gray-100 rounded-md px-4 w-full mb-4 '>
